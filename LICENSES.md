...
| shadcn | 4.19.0, preset `b0` | MIT | Project initialization and locally owned UI component source |
| Base UI React | 1.7.0 | MIT | Accessible primitives used by generated shadcn components |
...
OpenAI Codex/ChatGPT assisted with implementation, test generation, interface composition and documentation. Output was verified through participant review, hand-calculated edge cases, 39 automated tests (including all 25 published cases), TypeScript and ESLint checks, a production build, and desktop/mobile browser QA.

## Original-work statement

Everything not declared in this file or `EVENT.md` was created by the registered participant during the event window.
