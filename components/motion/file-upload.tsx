  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        >
          <FileKindIcon item={item} className="h-5 w-5" />
        </div>
        ...
        <div className={cn("min-w-0 flex-1", classNames?.content)}>
          ...
          {showProgress ? (
            <div
              ...
              aria-label={`${item.name} processing progress`}
              className={cn(
...
export function FileUpload({
  ...
  return (
    <div
      className={cn("flex w-full flex-col gap-3", className, classNames?.root)}
    >
      <input
        ref={inputRef}
        id={inputId}
      ...
      <ul className={cn("flex flex-col gap-2", classNames?.queue)}>
